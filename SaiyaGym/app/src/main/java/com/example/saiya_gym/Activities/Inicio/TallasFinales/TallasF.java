package com.example.saiya_gym.Activities.Inicio.TallasFinales;

public class TallasF {
    private String usuario,hombros,pecho,espalda,brazos,abdomen,pierna;

    public TallasF(){}

    public TallasF(String usuario, String hombros, String pecho, String espalda, String brazos, String abdomen, String pierna) {
