...
public class PechoFragment extends Fragment {
    ...
    View view;
    Activity actividad;
    iComunicaFragments interfaceComunicaPecho;

    public PechoFragment() {

    }

    public static PechoFragment newInstance() {
        PechoFragment fragment = new PechoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view =  inflater.inflate(R.layout.fragment_pecho, container, false);
    ...
    private void iniciar() {
        musculosList.add(new Musculos("Press banca recta",R.drawable.pressbancarecta));
        musculosList.add(new Musculos("Apertura con mancuernas",R.drawable.aperturaconmancuernasacostado));
        musculosList.add(new Musculos("Cruce de poleas",R.drawable.crucedepoleas));
        musculosList.add(new Musculos("Flexiones",R.drawable.flexiones));
        musculosList.add(new Musculos("Pull over",R.drawable.pullover));
    ...
    private void mostrarData() {
        ...
        musculosAdapter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                interfaceComunicaPecho.enviarPecho(musculosList.get(recyclerView.getChildAdapterPosition(view)));
            }
        });
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof Activity){
            ...
            interfaceComunicaPecho =(iComunicaFragments) this.actividad;
        }
    }
